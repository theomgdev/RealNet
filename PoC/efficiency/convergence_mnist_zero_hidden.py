...
def main():
    print("RealNet 2.0: ZERO-HIDDEN Testing - MNIST...")
    DEVICE = 'cuda' if torch.cuda.is_available() else 'cpu'

    # HYPOTHESIS: Input neurons act as hidden neurons after t=0.
    # We remove ALL extra buffer neurons.
